...
<div class="bs-example bs-example-tabs right-sidebar-tab-notification" data-example-id="togglable-tabs">
    ...
    <!-- <div id="w3lDemoBar" class="w3l-demo-bar">
        ...
        <a href="../../../../../../checkout/checkout.html" class="no-margin-bottom-mobile">
					...
					<li>
						<div class="slider-info  banner-view banner-top1 bg bg2">
							<div class="banner-info">
								...
								<p>Lorem ipsum dolor sit amet consectetur adipisicing elit.<span class="over-para"> Consequuntur hic odio
									voluptatem tenetur consequatur.</span></p>
								<a href="{{url('/')}}#small-dialog2" class="popup-with-zoom-anim play-view1">
									<span class="video-play-icon">
										<span class="fa fa-play"></span>
									</span>
									<h6>Watch Trailer</h6>
					...
					<li>
						<div class="slider-info banner-view banner-top2 bg bg2">
							<div class="banner-info">
								...
								<p>Lorem ipsum dolor sit amet consectetur adipisicing elit.<span class="over-para"> Consequuntur hic odio
									voluptatem tenetur consequatur.</span></p>
								<a href="{{url('/')}}#small-dialog3" class="popup-with-zoom-anim play-view1">
									<span class="video-play-icon">
										<span class="fa fa-play"></span>
									</span>
									<h6>Watch Trailer</h6>
					...
					<li>
						<div class="slider-info banner-view banner-top3 bg bg2">
							<div class="banner-info">
								...
								<p>Lorem ipsum dolor sit amet consectetur adipisicing elit.<span class="over-para"> Consequuntur hic odio
									voluptatem tenetur consequatur.</span></p>
								<a href="{{url('/')}}#small-dialog4" class="popup-with-zoom-anim play-view1">
									<span class="video-play-icon">
										<span class="fa fa-play"></span>
									</span>
									<h6>Watch Trailer</h6>
				...
				<div class="w3l-populohny-grids">
					<div class="item vhny-grid">
						<div class="box16">
							<a href="genre.html">
								<figure>
									<img class="img-fluid" src="{{asset('ps/assets/images/m7.jpg')}}" alt="">
								</figure>
					...
					<div class="item vhny-grid">
						<div class="box16">
							<a href="#">
								<figure>
									<img class="img-fluid" src="{{asset('ps/assets/images/m3.jpg')}}" alt="">
								</figure>
								<div class="box-content">
					...
					<div class="item vhny-grid">
						<div class="box16">
							<a href="#">
								<figure>
									<img class="img-fluid" src="{{asset('ps/assets/images/m4.jpg')}}" alt="">
								</figure>
								<div class="box-content">
					...
					<div class="item vhny-grid">
						<div class="box16">
							<a href="#">
								<figure>
									<img class="img-fluid" src="{{asset('ps/assets/images/m5.jpg')}}" alt="">
								</figure>
								<div class="box-content">
			...
			<div class="container py-lg-3">
				<div class="headerhny-title">
					<div class="w3l-title-grids">
						...
						<div class="headerhny-right text-lg-right">
							<h4><a class="show-title" href="{{asset('ps/genre.html')}}">Show all</a></h4>
						</div>
					</div>
				</div>
				<div class="owl-three owl-carousel owl-theme">
					<div class="item vhny-grid">
						<div class="box16 mb-0">
							<a href="{{asset('ps/genre.html')}}">
								<figure>
									<img class="img-fluid" src="{{asset('ps/assets/images/n1.jpg')}}" alt="">
								</figure>
								<div class="box-content">
						...
						<h3> <a class="title-gd" href="{{asset('ps/genre.html')}}">No Time to Die</a></h3>
						<p>Lorem ipsum dolor sit amet consectetur adipisicing elit</p>
						<div class="button-center text-center mt-4">
							<a href="{{asset('ps/genre.html')}}" class="btn watch-button">Watch now</a>
						</div>
					...
					<div class="item vhny-grid">
						<div class="box16 mb-0">
							<a href="{{asset('ps/genre.html')}}">
								<figure>
									<img class="img-fluid" src="{{asset('ps/assets/images/n2.jpg')}}" alt="">
								</figure>
								<div class="box-content">
						...
						<h3> <a class="title-gd" href="{{asset('ps/genre.html')}}">Mulan</a></h3>
						<p>Lorem ipsum dolor sit amet consectetur adipisicing elit</p>
						<div class="button-center text-center mt-4">
							<a href="{{asset('ps/genre.html')}}" class="btn watch-button">Watch now</a>
						</div>
					...
					<div class="item vhny-grid">
						<div class="box16 mb-0">
							<a href="{{asset('ps/genre.html')}}">
								<figure>
									<img class="img-fluid" src="{{asset('ps/assets/images/n3.jpg')}}" alt="">
								</figure>
								<div class="box-content">
						...
						<h3> <a class="title-gd" href="{{asset('ps/genre.html')}}">Free Guy</a></h3>
						<p>Lorem ipsum dolor sit amet consectetur adipisicing elit</p>
						<div class="button-center text-center mt-4">
							<a href="{{asset('ps/genre.html')}}" class="btn watch-button">Watch now</a>
						</div>
					...
					<div class="item vhny-grid">
						<div class="box16 mb-0">
							<a href="{{asset('ps/genre.html')}}">
								<figure>
									<img class="img-fluid" src="{{asset('ps/assets/images/n4.jpg')}}" alt="">
								</figure>
								<div class="box-content">
						...
						<h3> <a class="title-gd" href="{{asset('ps/genre.html')}}">My Spy</a></h3>
						<p>Lorem ipsum dolor sit amet consectetur adipisicing elit</p>
						<div class="button-center text-center mt-4">
							<a href="{{asset('ps/genre.html')}}" class="btn watch-button">Watch now</a>
						</div>
					...
					<div class="item vhny-grid">
						<div class="box16 mb-0">
							<a href="{{asset('ps/genre.html')}}">
								<figure>
									<img class="img-fluid" src="{{asset('ps/assets/images/n5.jpg')}}" alt="">
								</figure>
								<div class="box-content">
						...
						<h3> <a class="title-gd" href="{{asset('ps/genre.html')}}">Scoob</a></h3>
						<p>Lorem ipsum dolor sit amet consectetur adipisicing elit</p>
						<div class="button-center text-center mt-4">
							<a href="{{asset('ps/genre.html')}}" class="btn watch-button">Watch now</a>
						</div>
					...
					<div class="item vhny-grid">
						<div class="box16 mb-0">
							<a href="{{asset('ps/genre.html')}}">
								<figure>
									<img class="img-fluid" src="{{asset('ps/assets/images/n6.jpg')}}" alt="">
								</figure>
								<div class="box-content">
						...
						<h3> <a class="title-gd" href="{{asset('ps/genre.html')}}">Downhill</a></h3>
						<p>Lorem ipsum dolor sit amet consectetur adipisicing elit</p>
						<div class="button-center text-center mt-4">
							<a href="{{asset('ps/genre.html')}}" class="btn watch-button">Watch now</a>
						</div>
						...
						<div class="slider-info mid-view bg bg2">
							<div class="container">
								<div class="mid-info">
									...
									<a class="watch" href="{{asset('ps/genre.html')}}"><span class="fa fa-play"
											aria-hidden="true"></span>
										Watch Trailer</a>
								</div>
							</div>
							...
							<div class="albums-content">
								<div class="row">
										...
										<div class="slider-info">
											<div class="img-circle">
												<a href="{{asset('ps/genre.html')}}">
													...
													<img src="{{asset('ps/assets/images/m6.jpg')}}" class="img-fluid"
														alt="author image">
									...
									<div class="col-lg-4 new-relise-gd mt-lg-0 mt-0">
										<div class="slider-info">
											<div class="img-circle">
												<a href="{{asset('ps/genre.html')}}"><img src="{{asset('ps/assets/images/m5.jpg')}}" class="img-fluid"
														alt="author image">
													<div class="overlay-icon">
									...
									<div class="col-lg-4 new-relise-gd mt-lg-0 mt-0">
										<div class="slider-info">
											<div class="img-circle">
												<a href="{{asset('ps/genre.html')}}"><img src="{{asset('ps/assets/images/m4.jpg')}}" class="img-fluid"
														alt="author image">
													<div class="overlay-icon">
									...
									<div class="col-lg-4 new-relise-gd mt-lg-0 mt-0">
										<div class="slider-info">
											<div class="img-circle">
												<a href="{{asset('ps/genre.html')}}"><img src="{{asset('ps/assets/images/m1.jpg')}}" class="img-fluid"
														alt="author image">
													<div class="overlay-icon">
									...
									<div class="col-lg-4 new-relise-gd mt-lg-0 mt-0">
										<div class="slider-info">
											<div class="img-circle">
												<a href="{{asset('ps/genre.html')}}"><img src="{{asset('ps/assets/images/m2.jpg')}}" class="img-fluid"
														alt="author image">
													<div class="overlay-icon">
									...
									<div class="col-lg-4 new-relise-gd mt-lg-0 mt-0">
										<div class="slider-info">
											<div class="img-circle">
												<a href="genre.html"><img src="{{asset('ps/assets/images/m3.jpg')}}" class="img-fluid"
														alt="author image">
													<div class="overlay-icon">
									...
									<div class="col-lg-4 new-relise-gd mt-lg-0 mt-0">
										<div class="slider-info">
											<div class="img-circle">
												<a href="{{asset('ps/genre.html')}}"><img src="{{asset('ps/assets/images/n1.jpg')}}" class="img-fluid"
														alt="author image">
													<span class="fa fa-play video-icon" aria-hidden="true"></span>
												</a>
											</div>
									...
									<div class="col-lg-4 new-relise-gd mt-lg-0 mt-0">
										<div class="slider-info">
											<div class="img-circle">
												<a href="{{asset('ps/genre.html')}}"><img src="{{asset('ps/assets/images/n2.jpg')}}" class="img-fluid"
														alt="author image">
													<div class="overlay-icon">
									...
									<div class="col-lg-4 new-relise-gd mt-lg-0 mt-0">
										<div class="slider-info">
											<div class="img-circle">
												<a href="{{asset('ps/genre.html')}}"><img src="{{asset('ps/assets/images/n3.jpg')}}" class="img-fluid"
														alt="author image">
													<div class="overlay-icon">
							...
							<div class="albums-content">
								<div class="row">
									...
									<div class="col-lg-4 new-relise-gd mt-lg-0 mt-0">
										<div class="slider-info">
											<div class="img-circle">
												<a href="{{asset('ps/genre.html')}}"><img src="{{asset('ps/assets/images/m3.jpg')}}" class="img-fluid"
														alt="author image">
													<div class="overlay-icon">
									...
									<div class="col-lg-4 new-relise-gd mt-lg-0 mt-0">
										<div class="slider-info">
											<div class="img-circle">
												<a href="{{asset('ps/genre.html')}}"><img src="{{asset('ps/assets/images/m7.jpg')}}" class="img-fluid"
														alt="author image">
													<div class="overlay-icon">
									...
									<div class="col-lg-4 new-relise-gd mt-lg-0 mt-0">
										<div class="slider-info">
											<div class="img-circle">
												<a href="{{asset('ps/genre.html')}}"><img src="{{asset('ps/assets/images/m8.jpg')}}" class="img-fluid"
														alt="author image">
													<div class="overlay-icon">
									...
									<div class="col-lg-4 new-relise-gd mt-lg-0 mt-0">
										<div class="slider-info">
											<div class="img-circle">
												<a href="{{asset('ps/genre.html')}}"><img src="{{asset('ps/assets/images/m9.jpg')}}" class="img-fluid"
														alt="author image">
													<div class="overlay-icon">
							...
							<div class="albums-content">
								<div class="row">
									...
									<div class="col-lg-4 new-relise-gd mt-lg-0 mt-0">
										<div class="slider-info">
											<div class="img-circle">
												<a href="{{asset('ps/genre.html')}}"><img src="{{asset('ps/assets/images/m10.jpg')}}" class="img-fluid"
														alt="author image">
													<div class="overlay-icon">
									...
									<div class="col-lg-4 new-relise-gd mt-lg-0 mt-0">
										<div class="slider-info">
											<div class="img-circle">
												<a href="{{asset('ps/genre.html')}}"><img src="{{asset('ps/assets/images/m11.jpg')}}" class="img-fluid"
														alt="author image">
													<div class="overlay-icon">
									...
									<div class="col-lg-4 new-relise-gd mt-lg-0 mt-0">
										<div class="slider-info">
											<div class="img-circle">
												<a href="{{asset('ps/genre.html')}}"><img src="{{asset('ps/assets/images/m12.jpg')}}" class="img-fluid"
														alt="author image">
													<div class="overlay-icon">
...
<!-- responsive tabs -->
<script src="{{asset('ps/assets/js/jquery-1.9.1.min.js')}}"></script>
  <script src="{{asset('ps/assets/js/easyResponsiveTabs.js')}}"></script>
...
<!-- //responsive tabs -->
<!--/theme-change-->
<script src="{{asset('ps/assets/js/theme-change.js')}}"></script>
<!-- //theme-change-->
<script src="{{asset('ps/assets/js/owl.carousel.js')}}"></script>
...
<!-- Template JavaScript -->
<script src="{{asset('ps/assets/js/jquery.magnific-popup.min.js')}}"></script>
<script>
	$(document).ready(function () {
...
<script src="{{asset('ps/assets/js/bootstrap.min.js')}}"></script>